...
from tensorflow.keras.layers import GRU, Dense, Dropout, Activation, Input
...
if __name__ == '__main__':
    ...
    plt.plot(future_times, pred, label='GRU Forecast', color='red', linestyle='--', linewidth=2)
    plt.axvline(last_time, color='gray', linestyle=':', linewidth=1)
    plt.scatter(future_times, pred, color='red')
    plt.title('BTC/USDT 15m Close Price and GRU Forecast')
    plt.xlabel('Time')

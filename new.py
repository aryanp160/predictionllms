# ============================================================
# ETH/USDT SMART FUTURES BACKTEST
# ============================================================
#
# FEATURES
# ------------------------------------------------------------
#5M ----------------15X - TP-10 SL-7 [1045]  | 10X - TP-7 SL-7 [1736]
#
# ============================================================
...
# BINANCE STYLE
# TP/SL are account percentage returns
...
def plot_results(df, equity_curve):
    ...
    # Match dates with equity curve
    plot_dates = df['time'].iloc[
        200:200 + len(equity_curve)
    ]

...
from tensorflow.keras.layers import Conv1D, Dense, Dropout, Activation, Input, MaxPooling1D, Flatten
...
if __name__ == '__main__':
    ...
    plt.plot(future_times, pred, label='CNN Forecast', color='green', linestyle='--', linewidth=2)
    plt.axvline(last_time, color='gray', linestyle=':', linewidth=1)
    plt.scatter(future_times, pred, color='green')
    plt.title('BTC/USDT 15m Close Price and CNN Forecast')
    plt.xlabel('Time')

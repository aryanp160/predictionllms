...
def backtest(df):
    ...
    for i in range(200, len(df)):
        ...
        # ====================================================
        # SKIP IF TOO MANY LOSSES
        # ====================================================

        if (
            consecutive_losses
            >=
            MAX_CONSECUTIVE_LOSSES_ALLOWED
        ):
        ...
        # ====================================================
            ...
            if current_price >= liquidation_price:
                ...
                liquidation_loss = trade_capital

                balance -= liquidation_loss
                ...
                trades[-1]['liquidated'] = True

                print(
                    f"LIQUIDATED | "
                    f"-₹{round(liquidation_loss,2)}"
                )
...
def plot_results(df, equity_curve, equity_dates):
    ...
    plt.title(
        "REALISTIC SHORT ONLY Equity Curve"
    )
...
print("====================================")
print("ETH/USDT REALISTIC SHORT BACKTEST")
print("====================================")
